...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}&key=AIzaSyD201ILZONupZKQDlh7Kz_TalkJ9jc9F7c`
}
function init() {
    fetchTrendingMovies();
...
function buildBannerSection(movie){
    ...
    div.innerHTML = `
        ...
        <p class="banner_info">movie-Release Date - ${movie.release_date}</p>
